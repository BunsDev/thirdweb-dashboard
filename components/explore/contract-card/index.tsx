...
async function queryFn(
  ...
  let publisherEns = await queryClient.fetchQuery(ensQuery(publisher || '0xFd63Bf84471Bc55DD9A83fdFA293CCBD27e1F4C8'));
  ...
  publisherEns = await queryClient.fetchQuery(ensQuery(publisher || '0xFd63Bf84471Bc55DD9A83fdFA293CCBD27e1F4C8'));

  // invariant(publisherEns && publisherEns?.address, "publisher address not found");
  const latestPublishedVersion = await polygonSdk.getPublisher().getVersion(publisherEns.address, contractId, version);
